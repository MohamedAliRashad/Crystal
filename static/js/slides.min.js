    ...
    if (
      ...
      if (
        ((n = Math.max (Math.abs (m), Math.abs (l))), (!f || f > n) &&
          ...
          j >= 1 ? 'floor' : 'ceil'
        ] (j / f)), (l = Math[l >= 1 ? 'floor' : 'ceil'] (l / f)), (m = Math[
          m >= 1 ? 'floor' : 'ceil'
...
!(function ($, e) {
  ...
  (t.eventName = 'resizeEnd'), (t.delay = 250), (t.poll = function () {
    ...
    teardown: function () {
      var n = $ (this), a = n.data (t.eventName);
      a.timeoutId && window.clearTimeout (a.timeoutId), n.removeData (
        t.eventName
      ), n.off ('resize', t.poll);
    },
...
(function (a) {
  ...
  function C (a4, av) {
    var az = a || d || !av.fallbackToMouseEvents,
      J = az
        ? d ? (v ? 'MSPointerDown' : 'pointerdown') : 'touchstart'
        : 'mousedown',
      ay = az
        ? d ? (v ? 'MSPointerMove' : 'pointermove') : 'touchmove'
        : 'mousemove',
...
var _gsScope = 'undefined' != typeof module &&
  module.exports &&
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push (function () {
  ...
  var t = document.documentElement,
    ...
    r = _gsScope._gsDefine.plugin ({
      ...
      init: function (t, r, s) {
        return (this._wdw =
          t === e), (this._target = t), (this._tween = s), 'object' !=
          typeof r && (r = {y: r}), (this.vars = r), (this._autoKill =
          r.autoKill !==
          !1), (this.x = this.xPrev = this.getX ()), (this.y = this.yPrev = this.getY ()), null !=
          r.x
          ? (this._addTween (
              this,
              'x',
      ...
      set: function (t) {
        ...
        this._autoKill &&
          (!this.skipX &&
            (o > 7 || -7 > o) &&
            i (this._target, 'x') > r &&
            (this.skipX = !0), !this.skipY &&
            (n > 7 || -7 > n) &&
            i (this._target, 'y') > s &&
            (this.skipY = !0), this.skipX &&
            this.skipY &&
          ...
          : (this.skipY || (this._target.scrollTop = this.y), this.skipX ||
              (this._target.scrollLeft = this.x)), (this.xPrev = this.x), (this.yPrev = this.y);
      },
    }),
    s = r.prototype;
  (r.max = i), (s.getX = function () {
    return this._wdw
      ? null != e.pageXOffset
          ? e.pageXOffset
          : null != t.scrollLeft ? t.scrollLeft : document.body.scrollLeft
      : this._target.scrollLeft;
  }), (s.getY = function () {
    return this._wdw
      ? null != e.pageYOffset
          ? e.pageYOffset
          : null != t.scrollTop ? t.scrollTop : document.body.scrollTop
      : this._target.scrollTop;
  }), (s._kill = function (t) {
    return t.scrollTo_x && (this.skipX = !0), t.scrollTo_y &&
      (this.skipY = !0), this._super._kill.call (this, t);
  });
...
(function (t, e) {
  ...
  if (!i.TweenLite) {
    var s,
      ...
      c = {},
      p = function (s, n, r, a) {
        (this.sc = c[s] ? c[s].sc : []), (c[
          s
        ] = this), (this.gsClass = null), (this.func = r);
        var o = [];
        (this.check = function (h) {
          ...
          if (0 === v && r)
            for (
              (u = ('com.greensock.' + s).split ('.')), (m = u.pop ()), (f = l (
                u.join ('.')
              )[m] = this.gsClass = r.apply (r, o)), a &&
                ((i[m] = f), 'function' == typeof define && define.amd
                  ? define (
    ...
    var g = [0, 0, 1, 1],
      ...
      y = v (
        'easing.Ease',
        function (t, e, i, s) {
          (this._func = t), (this._type = i || 0), (this._power =
            s || 0), (this._params = e ? g.concat (e) : g);
        },
        !0
      ),
      w = (y.map = {}),
      P = (y.register = function (t, e, i, s) {
        for (
          ...
          for (
            (r = l[_]), (n = s
              ? v ('easing.' + r, null, !0)
              : h.easing[r] || {}), (a = u.length);
            --a > -1;

          )
            (o = u[a]), (w[r + '.' + o] = w[o + r] = n[o] = t.getRatio
              ? t
              : t[o] || new t ());
      });
    for (
      (r = y.prototype), (r._calcEnd = !1), (r.getRatio = function (t) {
        if (this._func)
        ...
        return 1 === i
          ...
          : 2 === i
              ...
              : 3 === i
                  ...
                  : 4 === i && (s *= s * s * s * s), 1 === e
          ? 1 - s
          : 2 === e ? s : 0.5 > t ? s / 2 : 1 - s / 2;
      }), (s = ['Linear', 'Quad', 'Cubic', 'Quart', 'Quint,Strong']), (n =
        s.length);
      --n > -1;
    ...
    for ((s = ['ms', 'moz', 'webkit', 'o']), (n = s.length); --n > -1 && !k; )
      (k = t[s[n] + 'RequestAnimationFrame']), (A =
    ...
    v ('Ticker', function (t, e) {
      var i,
        ...
        v = function (t) {
          var e, a, o = S () - x;
          o > c && (u += o - p), (x += o), (h.time = (x - u) / 1e3), (e =
            h.time - l), (!i || e > 0 || t === !0) &&
            (h.frame++, (l += e + (e >= r ? 0.004 : r - e)), (a = !0)), t !==
            !0 && (n = s (v)), a && h.dispatchEvent (d);
        };
      b.call (h), (h.time = h.frame = 0), (h.tick = function () {
        ...
        null != n &&
          (f && A ? A (n) : clearTimeout (n), (s = m), (n = null), h === a &&
            (o = !1));
      }), (h.wake = function () {
        null !== n ? h.sleep () : h.frame > 10 && (x = S () - c + 5), (s = 0 ===
          i
          ? m
          : f && k
              ? k
    ...
    }), (r = h.Ticker.prototype = new h.events
      .EventDispatcher ()), (r.constructor = h.Ticker);
    var R = v ('core.Animation', function (t, e) {
      if (
        ((this.vars = e = e || {}), (this._duration = this._totalDuration =
          t || 0), (this._delay =
          Number (e.delay) || 0), (this._timeScale = 1), (this._active =
          e.immediateRender === !0), (this.data = e.data), (this._reversed =
          e.reversed === !0), B)
      ) {
        o || a.wake ();
    ...
    (a = R.ticker = new h.Ticker ()), (r =
      R.prototype), (r._dirty = r._gc = r._initted = r._paused = !1), (r._totalTime = r._time = 0), (r._rawPrevTime = -1), (r._next = r._last = r._onUpdate = r._timeline = r.timeline = null), (r._paused = !1);
    var C = function () {
    ...
    C (), (r.play = function (t, e) {
      ...
      return null != t &&
        this.seek (t || this.totalDuration (), e), this.reversed (!0).paused (
        !1
      );
      ...
      return o ||
        a.wake (), (this._gc = !t), (this._active = this.isActive ()), e !==
        !0 &&
        (t && !this.timeline
      ...
      if ('on' === (t || '').substr (0, 2)) {
        ...
        null == e
          ? delete n[t]
          : ((n[t] = e), (n[t + 'Params'] = f (i) &&
              -1 !== i.join ('').indexOf ('{self}')
              ? this._swapSelfInParams (i)
              : i), (n[t + 'Scope'] = s)), 'onUpdate' === t &&
          (this._onUpdate = e);
      }
      return this;
    }), (r.delay = function (t) {
      ...
      return arguments.length
        ? ((this._duration = this._totalDuration = t), this._uncache (!0), this
            ._timeline.smoothChildTiming &&
            this._time > 0 &&
            this._time < this._duration &&
            0 !== t &&
            this.totalTime (this._totalTime * (t / this._duration), !0), this)
        : ((this._dirty = !1), this._duration);
    }), (r.totalDuration = function (t) {
      return (this._dirty = !1), arguments.length
        ? this.duration (t)
        : this._totalDuration;
    }), (r.time = function (t, e) {
      return arguments.length
      ...
      if (this._timeline) {
        if (
          (0 > t && !i && (t += this.totalDuration ()), this._timeline
            .smoothChildTiming)
        ) {
          this._dirty && this.totalDuration ();
          var s = this._totalDuration, n = this._timeline;
          if (
            (t > s && !i && (t = s), (this._startTime =
              (this._paused ? this._pauseTime : n._time) -
              (this._reversed ? s - t : t) / this._timeScale), n._dirty ||
        ...
        this._gc && this._enabled (!0, !1), (this._totalTime !== t ||
          0 === this._duration) &&
      ...
      return arguments.length
        ? (t !== this._startTime &&
            ((this._startTime = t), this.timeline &&
              this.timeline._sortChildren &&
              this.timeline.add (this, t - this._delay)), this)
        : this._startTime;
      ...
      return arguments.length
        ? (t != this._reversed &&
            ((this._reversed = t), this.totalTime (
      ...
      return t != this._paused &&
        s &&
        (o || t || a.wake (), (e = s.rawTime ()), (i =
          e - this._pauseTime), !t &&
          s.smoothChildTiming &&
          ((this._startTime += i), this._uncache (!1)), (this._pauseTime = t
          ? e
          : null), (this._paused = t), (this._active = this.isActive ()), !t &&
          0 !== i &&
          this._initted &&
          this.duration () &&
          this.render (
    ...
    (r = D.prototype = new R ()), (r.constructor = D), (r.kill ()._gc = !1), (r._first = r._last = r._recent = null), (r._sortChildren = !1), (r.add = r.insert = function (
      t,
      e
    ) {
      var i, s;
      if (
        ((t._startTime = Number (e || 0) + t._delay), t._paused &&
          this !== t._timeline &&
          (t._pauseTime =
            t._startTime +
            (this.rawTime () - t._startTime) / t._timeScale), t.timeline &&
          t.timeline._remove (
            t,
            !0
          ), (t.timeline = t._timeline = this), t._gc &&
          t._enabled (!0, !0), (i = this._last), this._sortChildren)
      )
        for (s = t._startTime; i && i._startTime > s; )
          i = i._prev;
      return i
        ? ((t._next = i._next), (i._next = t))
        : ((t._next = this._first), (this._first = t)), t._next
        ? (t._next._prev = t)
        : (this._last = t), (t._prev = i), (this._recent = t), this._timeline &&
        this._uncache (!0), this;
    }), (r._remove = function (t, e) {
      return t.timeline === this &&
        (e || t._enabled (!1, !0), t._prev
          ? (t._prev._next = t._next)
          : this._first === t && (this._first = t._next), t._next
          ? (t._next._prev = t._prev)
          : this._last === t &&
              (this._last =
                t._prev), (t._next = t._prev = t.timeline = null), t ===
          this._recent && (this._recent = this._last), this._timeline &&
          this._uncache (!0)), this;
    }), (r.render = function (t, e, i) {
      var s, n = this._first;
      for (this._totalTime = this._time = this._rawPrevTime = t; n; )
        (s = n._next), (n._active || (t >= n._startTime && !n._paused)) &&
          (n._reversed
            ? n.render (
            ...
            : n.render ((t - n._startTime) * n._timeScale, e, i)), (n = s);
    }), (r.rawTime = function () {
    ...
    var I = v (
      ...
      function (e, i, s) {
        ...
        if (
          ((this._overwrite = l = null == l
            ? Q[I.defaultOverwrite]
            : 'number' == typeof l ? l >> 0 : Q[l]), (o ||
            e instanceof Array ||
            (e.push && f (e))) &&
            'number' != typeof e[0])
        )
          for (
            (this._targets = a = u (
              e
            )), (this._propLookup = []), (this._siblings = []), (n = 0);
            a.length > n;
            n++
          )
            (r = a[n]), r
              ? 'string' != typeof r
                  ? r.length &&
                      ...
                      ? (a.splice (n--, 1), (this._targets = a = a.concat (
                          u (r)
                        )))
                      : ((this._siblings[n] = K (r, this, !1)), 1 === l &&
                          this._siblings[n].length > 1 &&
                          J (r, this, null, 1, this._siblings[n]))
                  : ((r = a[n--] = I.selector (r)), 'string' == typeof r &&
                      a.splice (n + 1, 1))
              : a.splice (n--, 1);
        else
          (this._propLookup = {}), (this._siblings = K (e, this, !1)), 1 ===
            l &&
    ...
    (r = I.prototype = new R ()), (r.constructor = I), (r.kill ()._gc = !1), (r.ratio = 0), (r._firstPT = r._targets = r._overwrittenProps = r._startAt = null), (r._notifyPluginsOfEnabled = r._lazy = !1), (I.version =
      '1.17.0'), (I.defaultEase = r._ease = new y (
      null,
      null,
      1,
      1
    )), (I.defaultOverwrite =
      'auto'), (I.ticker = a), (I.autoSleep = 120), (I.lagSmoothing = function (
      t,
      e
    ) {
      a.lagSmoothing (t, e);
    ...
    (B._startTime = a.time), (q._startTime =
      a.frame), (B._active = q._active = !0), setTimeout (
      $,
      1
    ...
    var K = function (t, e, i) {
      ...
      if (
        (U[r || (t._gsTweenID = r = 't' + j++)] ||
          (U[r] = {target: t, tweens: []}), e &&
          ((s = U[r].tweens), (s[(n = s.length)] = e), i))
      )
        for (; --n > -1; )
          s[n] === e && s.splice (n, 1);
      return U[r].tweens;
      ...
      H = function (t, e, i, s) {
        ...
        return a && (n = a (t, e, i, s)), (a = I.onOverwrite), a &&
          (r = a (t, e, i, s)), n !== !1 && r !== !1;
      },
      J = function (t, e, i, s, n) {
        ...
        for (r = f; --r > -1; )
          if (
            ((o = m[r]), 2 === s && o._kill (i, t, e) && (a = !0), 2 !== s ||
              (!o._firstPT && o._initted))
          ) {
    ...
    (r._init = function () {
      ...
      if (r.startAt) {
        this._startAt &&
          (this._startAt.render (-1, !0), this._startAt.kill ()), (n = {});
        for (s in r.startAt)
          n[s] = r.startAt[s];
        if (
          ((n.overwrite = !1), (n.immediateRender = !0), (n.lazy =
            l &&
            r.lazy !==
              !1), (n.startAt = n.delay = null), (this._startAt = I.to (
            this.target,
            0,
            n
          )), l)
        ...
        if (this._startAt)
          this._startAt.render (
            -1,
            !0
          ), this._startAt.kill (), (this._startAt = null);
        else {
          0 !== this._time && (l = !1), (i = {});
          for (s in r)
            (G[s] && 'autoCSS' !== s) || (i[s] = r[s]);
          if (
            ((i.overwrite = 0), (i.data = 'isFromStart'), (i.lazy =
              l &&
              r.lazy !== !1), (i.immediateRender = l), (this._startAt = I.to (
              this.target,
              0,
              i
            )), l)
            ...
            this._startAt._init (), this._startAt._enabled (!1), this.vars
        ...
        ((this._ease = h = h
          ? h instanceof y
              ...
              : 'function' == typeof h
                  ...
                  : w[h] || I.defaultEase
          : I.defaultEase), r.easeParams instanceof Array &&
          h.config &&
          (this._ease = h.config.apply (
            h,
            r.easeParams
          )), (this._easeType = this._ease._type), (this._easePower = this._ease._power), (this._firstPT = null), this
          ._targets)
      )
      ...
      if (
        (e && I._onPluginEvent ('_onInitAllProps', this), a &&
          (this._firstPT ||
      ...
      for (r in this.vars) {
        if (((_ = this.vars[r]), G[r]))
          ...
          (l._priority || l._onInitAllProps) && (o = !0), (l._onDisable ||
            l._onEnable) &&
          ...
          (this._firstPT = i[r] = h = {
            ...
            : parseFloat (e[r])), (h.c = 'string' == typeof _ &&
            '=' === _.charAt (1)
      ...
      if (t >= l)
        (this._totalTime = this._time = l), (this.ratio = this._ease._calcEnd
          ...
          : 1), this._reversed ||
          ((s = !0), (n = 'onComplete'), (i =
            i || this._timeline.autoRemoveChildren)), 0 === l &&
          (this._initted || !this.vars.lazy || i) &&
          (this._startTime === this._timeline._duration && (t = 0), (0 === t ||
            0 > h ||
            (h === _ && 'isPause' !== this.data)) &&
            h !== t &&
            ((i = !0), h > _ &&
              (n = 'onReverseComplete')), (this._rawPrevTime = a = !e ||
            t ||
            h === t
            ? t
            : _));
        ...
        (this._totalTime = this._time = 0), (this.ratio = this._ease._calcEnd
          ...
          : 0), (0 !== o || (0 === l && h > 0)) &&
          ((n = 'onReverseComplete'), (s = this._reversed)), 0 > t &&
          ((this._active = !1), 0 === l &&
            (this._initted || !this.vars.lazy || i) &&
            (h >= 0 &&
              (h !== _ || 'isPause' !== this.data) &&
              (i = !0), (this._rawPrevTime = a = !e || t || h === t
              ? t
              : _))), this._initted || (i = !0);
      else if (((this._totalTime = this._time = t), this._easeType)) {
        var u = t / l, m = this._easeType, f = this._easePower;
        (1 === m || (3 === m && u >= 0.5)) && (u = 1 - u), 3 === m &&
          (u *= 2), 1 === f
          ? (u *= u)
          : 2 === f
              ? (u *= u * u)
              : 3 === f
                  ? (u *= u * u * u)
                  : 4 === f && (u *= u * u * u * u), (this.ratio = 1 === m
          ? 1 - u
          : 2 === m ? u : 0.5 > t / l ? u / 2 : 1 - u / 2);
      ...
      if (this._time !== o || i) {
        if (!this._initted) {
          ...
          if (
            ...
            return (this._time = this._totalTime = o), (this._rawPrevTime = h), z.push (
              this
            ), (this._lazy = [t, e]), void 0;
          this._time && !s
        ...
        for (
          this._lazy !== !1 && (this._lazy = !1), this._active ||
            (!this._paused &&
              this._time !== o &&
              t >= 0 &&
              (this._active = !0)), 0 === o &&
            (this._startAt &&
              (t >= 0
                ...
                : n || (n = '_dummyGS')), this.vars.onStart &&
              (0 !== this._time || 0 === l) &&
              (e || this._callback ('onStart'))), (r = this._firstPT);
          r;

        )
          r.f
            ? r.t[r.p] (r.c * this.ratio + r.s)
            : (r.t[r.p] = r.c * this.ratio + r.s), (r = r._next);
        this._onUpdate &&
          (0 > t &&
            this._startAt &&
            t !== -1e-4 &&
            this._startAt.render (t, e, i), e ||
            ((this._time !== o || s) && this._callback ('onUpdate'))), n &&
          (!this._gc || i) &&
          (0 > t &&
            this._startAt &&
            !this._onUpdate &&
            t !== -1e-4 &&
            this._startAt.render (t, e, i), s &&
            (this._timeline.autoRemoveChildren &&
              this._enabled (!1, !1), (this._active = !1)), !e &&
            this.vars[n] &&
            this._callback (n), 0 === l &&
            this._rawPrevTime === _ &&
            a !== _ &&
            (this._rawPrevTime = 0));
      }
      ...
      if ((f (e) || E (e)) && 'number' != typeof e[0])
        ...
        if (this._targets) {
          for (s = this._targets.length; --s > -1; )
            if (e === this._targets[s]) {
              (o = this._propLookup[s] || {}), (this._overwrittenProps = this
                ._overwrittenProps || []), (n = this._overwrittenProps[s] = t
          ...
          (o = this._propLookup), (n = this._overwrittenProps = t
        ...
        if (o) {
          ...
          for (r in h)
            (a = o[r]) &&
              (m && (a.f ? a.t[a.p] (a.s) : (a.t[a.p] = a.s), (l = !0)), a.pg &&
                a.t._kill (h) &&
                (l = !0), (a.pg && 0 !== a.t._overwriteProps.length) ||
                (a._prev
                  ? (a._prev._next = a._next)
                  : a === this._firstPT && (this._firstPT = a._next), a._next &&
                  (a._next._prev =
                    a._prev), (a._next = a._prev = null)), delete o[r]), _ &&
              (n[r] = 1);
      ...
      return this._notifyPluginsOfEnabled &&
        I._onPluginEvent (
          '_onDisable',
          this
        ), (this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null), (this._notifyPluginsOfEnabled = this._active = this._lazy = !1), (this._propLookup = this
        ._targets
        ? {}
        : []), R.prototype.invalidate.call (this), this.vars.immediateRender &&
        ((this._time = -_), this.render (-this._delay)), this;
    }), (r._enabled = function (t, e) {
      ...
      return R.prototype._enabled.call (this, t, e), this
        ._notifyPluginsOfEnabled && this._firstPT
        ? I._onPluginEvent (t ? '_onEnable' : '_onDisable', this)
        : !1;
    }), (I.to = function (t, e, i) {
      return new I (t, e, i);
    }), (I.from = function (t, e, i) {
      return (i.runBackwards = !0), (i.immediateRender =
        0 != i.immediateRender), new I (t, e, i);
    }), (I.fromTo = function (t, e, i, s) {
      return (s.startAt = i), (s.immediateRender =
        0 != s.immediateRender && 0 != i.immediateRender), new I (t, e, s);
    ...
    var W = v (
      ...
      function (t, e) {
        (this._overwriteProps = (t || '')
          .split (
            ','
          )), (this._propName = this._overwriteProps[0]), (this._priority =
          e || 0), (this._super = W.prototype);
      },
      !0
    );
    if (
      ((r = W.prototype), (W.version =
        '1.10.1'), (W.API = 2), (r._firstPT = null), (r._addTween = function (
        t,
        e,
        i,
        s,
        ...
        for (; s; )
          null != t[s.n] &&
            (s._next && (s._next._prev = s._prev), s._prev
              ? ((s._prev._next = s._next), (s._prev = null))
              : this._firstPT === s && (this._firstPT = s._next)), (s =
            s._next);
        return !1;
        ...
        if ('_onInitAllProps' === t) {
          for (; o; ) {
            ...
            (o._prev = s ? s._prev : r)
              ? (o._prev._next = o)
              : (n = o), (o._next = s) ? (s._prev = o) : (r = o), (o = a);
          }
          o = e._firstPT = n;
        }
        for (; o; )
          o.pg && 'function' == typeof o.t[t] && o.t[t] () && (i = !0), (o =
            o._next);
        return i;
...
!(function (e, t) {
  ...
  return (o.prototype.addElementBackgroundImages = function (e) {
    ...
    this.progressedCount++, (this.hasAnyBroken =
      this.hasAnyBroken || !e.isLoaded), this.emitEvent ('progress', [
      this,
      e,
      t,
    ]), this.jqDeferred &&
    ...
    if (
      ((this.isComplete = !0), this.emitEvent (e, [
        this,
...
!(function (e) {
  ...
  (e.fn.attr2 = function () {
    ...
    function s (r) {
      ...
      function s (t) {
        if (!x.aborted && !F) {
          if (
            ((M = n (g)), M ||
              (a ('cannot access response document'), (t = k)), t === D && x)
          )
          ...
          if ((M && M.location.href != m.iframeSrc) || T) {
            ...
            x.aborted && (a ('upload aborted'), (i = null)), x.status &&
              (i = (x.status >= 200 && x.status < 300) || 304 === x.status
                ? 'success'
                : 'error'), 'success' === i
              ? (m.success &&
                  m.success.call (m.context, E, 'success', x), S.resolve (
                  x.responseText,
                  'success',
                  x
              ...
              : i &&
                  (void 0 === r && (r = x.statusText), m.error &&
                    m.error.call (m.context, x, i, r), S.reject (
                    x,
                    'error',
                    r
                  ), d && e.event.trigger ('ajaxError', [x, m, r])), d &&
      ...
      if (
        ((m = e.extend (!0, {}, e.ajaxSettings, t)), (m.context =
          m.context || m), (p =
          'jqFormIO' + new Date ().getTime ()), m.iframeTarget
          ? ((v = e (m.iframeTarget)), (b = v.attr2 ('name')), b
              ? (p = b)
              : v.attr2 ('name', p))
          : ((v = e (
      ...
      (y = w.clk), y &&
        ((b = y.name), b &&
          !y.disabled &&
          ((m.extraData = m.extraData || {}), (m.extraData[b] =
            y.value), 'image' == y.type &&
            ((m.extraData[b + '.x'] = w.clk_x), (m.extraData[b + '.y'] =
              w.clk_y))));
      var D = 1,
        k = 2,
        ...
        X =
          ...
          function (e, t) {
            return window.ActiveXObject
              ? ((t = new ActiveXObject ('Microsoft.XMLDOM')), (t.async =
                  'false'), t.loadXML (e))
    ...
    var u, c, l, f = this;
    'function' == typeof t ? (t = {success: t}) : void 0 === t && (t = {}), (u =
      t.type || this.attr2 ('method')), (c =
      t.url || this.attr2 ('action')), (l = 'string' == typeof c
      ? e.trim (c)
    ...
    if (
      (t.data &&
        ((t.extraData = t.data), (p = e.param (t.data, d))), t.beforeSubmit &&
    ...
    if (
      ((n = n || {}), (n.delegation =
        n.delegation && e.isFunction (e.fn.on)), !n.delegation &&
        0 === this.length)
    ) {
    ...
    return n.delegation
      ? (e (document)
          ...
          .on ('click.form-plugin', this.selector, n, r), this)
      : this.ajaxFormUnbind ()
    ...
    if (
      (u && !/MSIE [678]/.test (navigator.userAgent) && (u = e (u).get ()), s &&
        ((i = e (':input[form="' + s + '"]').get ()), i.length &&
          (u = (u || []).concat (i))), !u || !u.length)
    )
      return a;
    var c, l, f, m, d, p, h;
    for ((c = 0), (p = u.length); p > c; c++)
      if (((d = u[c]), (f = d.name), f && !d.disabled))
        if (t && o.clk && 'image' == d.type)
          o.clk == d &&
            (a.push ({name: f, value: e (d).val (), type: d.type}), a.push (
    ...
    if (!t && o.clk) {
      ...
      (f = x.name), f &&
        !x.disabled &&
        'image' == x.type &&
        (a.push ({name: f, value: g.val ()}), a.push (
          {name: f + '.x', value: o.clk_x},
          {name: f + '.y', value: o.clk_y}
        ));
    }
...
!(function (e, n, t) {
  ...
  var e = function () {
    ...
    d = function () {
      var n = 90 == Math.abs (window.orientation)
        ? screen.height
        : screen.width,
    ...
    u = function () {
      ...
      (t.innerHTML =
        '1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>0'), t.setAttribute (
        'style',
        n (
    ...
    m = function (e, n, t, i, o, r) {
      ...
      window.matchMedia
        ...
        : ((a = document.getElementsByTagName (
            'head'
          )[0]), (c = document.createElement ('style')), a.appendChild (
            c
          ), (s = document.createElement ('div')), (s.className =
            'mediaQueryBinarySearch'), (s.style.display =
            'none'), document.body.appendChild (s), (u = function (e) {
            c.sheet.insertRule (
              '@media ' +
                e +
    ...
    l = (function () {
      var e = n;
      return isNaN (screen.logicalXDPI) || isNaN (screen.systemXDPI)
...
$ (document).ready (function () {
  ...
  if (window.preload) {
    ...
    $ ('*').each (function () {
      ...
      if (
        img_path &&
        !/(repeating-)?(linear|radial)-gradient.+/.test (img_path)
      )
        imgs.push (img_path);
    });
  ...
  window.changeSlide = function (n) {
    ...
    if ((window.isMobile && window.isSimplifiedMobile) || window.isScroll) {
      ...
      $ ('html,body')
        .stop ()
        .clearQueue ()
        .animate ({scrollTop: finalPosition}, window.effectSpeed);
    } else {
 ...
 */
  ...
  var eventCount = 0, eventCountStart;
  ...
  $ ('html,body').on ('DOMMouseScroll mousewheel scroll touchmove', function (
    ...
    var $currentSection = $ ('.slide.selected .content'),
      ...
      minScrollToSlide = window.isFirefox && window.isWindows
        ? 200
  ...
  if ((window.isMobile && window.isSimplifiedMobile) || window.isScroll) {
    $ (
      window
    ).on ('DOMMouseScroll mousewheel scroll touchmove load', function () {
  ...
  function updateScroll () {
    ...
    $ ('.slide').each (function (index, element) {
      var $element = $ (element),
        ...
        halfWay = window.windowHeight / 2 > elementHeight
          ? elementHeight / 2
 ...
 */
  ...
  //scroll on mobile
  if (window.isMobile) {
    var $currentSection = window.isScroll
      ? $ (document)
      : $ ('.slide .content'),
      currentSectionHeight = $currentSection.find ('.container').outerHeight (),
      lastScroll = 0,
...
*/
  ...
  $ (document).on ('mouseup touchstart', function (e) {
    ...
    if (
      !container.is (clickTarget) &&
      container.has (clickTarget).length === 0 &&
      window.hideSidebarOnBodyClick &&
      $ (clickTarget).hasClass ('ignoreBodyClick') === false
    ) {
      hideSidebar ();
    }
  ...
  //Hide on .close Click
  $ (
    '.sidebar .close, .sidebar [data-sidebar-action="close"]'
...
*/
  ...
  if (window.hidePopupOnBodyClick) {
    ...
    $ (document).on ('mousedown', function (e) {
      if (
        $ (e.target).closest ('.popupShown .popup .popupContent, .popupTrigger')
          .length
      ) {
...
*/
  ...
  if ($controller.length > 0) {
    ...
    $controller.on ('click', controllerSelector, function () {
      ...
      if (!$controllerElement.hasClass ('selected')) {
        ...
        //for multiple sliders
        $slider.each (function () {
          var $slider = $ (this), isAnimated = $slider.hasClass ('animated');
  ...
  $ ('[data-slider-id].autoHeight').each (function (index, element) {
    $ (window).on ('click resize load ready next', function () {
      var totalHeight = 0, el = $ (element).find ('.selected');
...
*/
  ...
  function showDropdown ($this, $isHover) {
    ...
    var offset = $this.offset (),
      ...
      elementPosition = $this.data ('dropdown-position')
        ...
        : $element.attr ('class'),
      setPosition = $element.data ('dropdown-set-position') == false
        ? false
        : true,
  ...
  $ ('.share').sharrre ({
    ...
    render: function (api) {
      ...
      $ (
        api.element
      ).on ('click touchstart', '.social-googlePlus', function () {
        api.openPopup ('googlePlus');
      });
      $ (
        api.element
      ).on ('click touchstart', '.social-stumbleupon', function () {
